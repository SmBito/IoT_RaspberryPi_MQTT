...
Applying MQTT protocol to turn ON/OFF a light, and to get Temperature and Humidity data and view it on an online dashboard
...
* or just download from Github as a ZIP file if you don't have `git` installed. From [here](https://github.com/SmBito/IoT_RaspberryPi_MQTT.git)

* go to `raspberryPi_mqtt/dasboard/js` (the repo you've just downloaded or cloned)
...
* go to `raspberryPi_mqtt/dasboard/`
